...
export const signupUser = (email, password) => {
  return function (dispatch) {
    ...
    axios
      .post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCN2OzwM2lHmCtjeIV-D9Xuld_j6Rx-TWg",
        data
      )
      .then((result) => {
...
export const autoLogoutAfterMillisec = (ms) => {
  return function (dispatch) {
    ...
    // axios
    //   .post(
    //     "https://securetoken.googleapis.com/v1/token?key=AIzaSyCN2OzwM2lHmCtjeIV-D9Xuld_j6Rx-TWg",
    //     {
